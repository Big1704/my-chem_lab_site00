...
urlpatterns = [
    ...
    # 📚 หมวดหมู่เรียนรู้ (เฉพาะเครื่องแก้ว)
    ...
    path(
        'pre-test/submit/',
        views.submit_quiz_pretest,
        name='submit_quiz_pretest',
    ),
    path(
        'pre-test/result/<int:pk>/',
        views.quiz_pretest_result,
        name='quiz_pretest_result',
    ),
    ...
    path(
        'quiz-40/result/<int:pk>/', views.quiz_40_result, name='quiz_40_result'
    ),

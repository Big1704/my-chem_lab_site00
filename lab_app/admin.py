...
# 3. 🌟 ตารางผลสอบแบบทดสอบ 40 ข้อ (Post-Test)
...
# 4. 📝 ตารางผลสอบแบบทดสอบก่อนเรียน (Pre-Test)
@admin.register(QuizPreTestResult)
class QuizPreTestResultAdmin(admin.ModelAdmin):
    list_display = (
        'user',
        'get_full_name',
        'score',
